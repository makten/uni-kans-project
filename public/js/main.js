...
},{"./admin_dashboard":10}],10:[function(require,module,exports){
'use strict';
...
router.map({
    ...
    '/create_user': {
        component: _create_edit_user2.default
    },
    ...
    '/create_propositie': {
        component: _create_edit_propositie2.default
    },
...
},{"./overview.vue":11,"./propositie/create_edit_propositie.vue":12,"./propositie/showpropositie.vue":13,"./user/create_edit_user.vue":14,"vue":7,"vue-moment":4,"vue-resource":5,"vue-router":6}],11:[function(require,module,exports){
...
},{"./home.js":16}],16:[function(require,module,exports){
'use strict';
...
new Vue({
    ...
    components: {
        Search: _search2.default, Themas: _themas2.default, Marktsegments: _marktsegments2.default, NavSearch: _navsearch2.default
    },
    computed: {
    ...
    methods: {
        handleSearchResults: function handleSearchResults(searchresults, navquery, pagination, page) {
    ...
    events: {
        'new-current_page': function newCurrent_page(current_page) {
...
},{"../mixins/helpers":22,"./marktsegments.vue":17,"./navsearch.vue":18,"./search.vue":19,"./themas.vue":20,"vue":7,"vue-moment":4,"vue-resource":5}],17:[function(require,module,exports){
'use strict';
...
exports.default = {
    data: function data() {
        return {
            ...
            }, { name: 'Bouw', link: '/propositie/marktsegment/bouw', icon: 'fa-home fa-2x' }, { name: 'Sport Cultuur & Recreatie', link: '/propositie/marktsegment/zorg', icon: 'fa-trophy fa-2x' }, { name: 'Industrie', link: '/propositie/marktsegment/industrie', icon: 'fa-industry fa-2x' }, {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-53ac3dc7", module.exports)
  } else {
...
},{"vue":7,"vue-hot-reload-api":3,"vueify/lib/insert-css":8}],20:[function(require,module,exports){
'use strict';
...
},{"./admin-components/admin_bootstrap":9,"./components/bootstrap":15}],22:[function(require,module,exports){
"use strict";
...
exports.default = {
    methods: {
        ...
        highlight: function highlight(what, spanClass) {
