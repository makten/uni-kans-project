//Vue.extend('propositie-comments', {
...
//{{--src="{{str_replace(public_path(), '', $comment->user->avatar)}}">--}}
//{{--</a>--}}
//
//
//
...
//{{--onclick="toggleReply('{{ $comment->id .'_'. $comment->created_at->format('Y-d-m')}}')">Reply</a>--}}
//{{--</p>--}}
//{{--</div>--}}
//{{--@endif--}}
//{{--<div style="display: none;"--}}
//{{--class="{{ $comment->id .'_'. $comment->created_at->format('Y-d-m')}}">--}}
