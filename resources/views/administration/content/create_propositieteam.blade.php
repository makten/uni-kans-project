<div class="modal fade" id="manageUserModal" tabindex="-1" role="dialog" aria-labelledby="manageUserLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header  modal_bg">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="manageUserLabel">New User</h4>
            </div>
            <div class="modal-body modal_bg">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('user.store') }}">
                    ...
                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control input-xs" name="first_name"
                    ...
                    <div class="form-group{{ $errors->has('user_role') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-3">
                            {!!Form::select('user_role', getRoles(), old('user_role'), ['class'=>'form-controller input-xs', 'id'=>'user_role'])!!}
