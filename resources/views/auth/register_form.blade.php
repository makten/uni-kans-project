  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header  modal_bg">
        ...
        <h4 class="modal-title" id="addUserLabel">New User</h4>
      </div>
      <div class="modal-body modal_bg">
        <form class="form-horizontal" role="form" method="POST" action="{{ url('user.store') }}">
            ...
            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control input-xs" name="first_name" value="{{ old('first_name') }}">
            ...
            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control input-xs" name="last_name" value="{{ old('last_name') }}">
